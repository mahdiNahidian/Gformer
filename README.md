...
architecture with temporal embeddings and the proposed G-PSA module.
...
meteorological, and financial time-series forecasting tasks.
...
``` bash
python main_gformer.py --model gformer --data ETTh1 --features M --seq_len 96 --label_len 48 --pred_len 24 --attn custom
```
